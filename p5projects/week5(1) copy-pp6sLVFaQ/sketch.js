...
function draw() {
  let letItMove=dist(mouseX,mouseY,pmouseX,pmouseY)
  background(116,115,173);
strokeWeight(4)
 addBox()
  line(width-60,200+30*cos(letItMove*0.04+PI*(0.89)*3)-5,width,200+30*cos(letItMove*0.04+PI*(0.89)*3)-5)
  circle(width-60,200+30*cos(letItMove*0.04+PI*(0.89)*3)-5,40)
  //line()
}
...
function wheels(xPos,start,img,Color){
  sinx=15*sin(letItMove*0.04+PI*start*3)
  cosy=30*cos(letItMove*0.04+PI*start*3)
  push()
