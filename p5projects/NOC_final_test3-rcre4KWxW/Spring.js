...
class Creature {
  ...
  this.balls[8].pos.y=(this.balls[1].pos.y-this.balls[0].pos.y)/3+this.balls[0].pos.y
  this.balls[13].pos.x=this.balls[1].pos.x
  this.balls[13].pos.y=2*(this.balls[1].pos.y-this.balls[0].pos.y)/3+this.balls[0].pos.y
