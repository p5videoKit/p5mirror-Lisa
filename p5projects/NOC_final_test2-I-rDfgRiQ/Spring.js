...
class Creature {
  constructor(x=0, y=0,angle=0) {
    ...
    this.springs.push(new Spring(b, c, 150, 0.2));
    ...
    for (let j = 0; j < 4; j++) {
      for (let i = 3; i < 6; i++) {
        this.springs.push(
          new Spring(this.balls[i + j * 4], this.balls[i + 1 + j * 4], 15, 0.2)
        );
      }
    }
  }
  ...
  this.balls[7].pos.x=this.balls[0].pos.x
  this.balls[7].pos.y=(this.balls[1].pos.y-this.balls[0].pos.y)/3+this.balls[0].pos.y
  this.balls[11].pos.x=this.balls[1].pos.x
  this.balls[11].pos.y=2*(this.balls[1].pos.y-this.balls[0].pos.y)/3+this.balls[0].pos.y
  this.balls[15].pos.x=this.balls[1].pos.x
  this.balls[15].pos.y=this.balls[1].pos.y
  ...
  this.balls[2].pos.add(createVector(sin(frameCount*0.1)*5,0))
  }
