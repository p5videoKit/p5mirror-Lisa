...
function draw() {
 ...
 // angle = angle + 5;
  ...
  if(mouseIsPressed){
  img2img(
    "a small girl in cartoon disney style wearing black shirt and white skirt, walking facing right, only black and white lines and colors, short hair, right or left leg up for walking",
    donePredicting,
    drawingLayer,
    drawingLayer
  );
