...
// let cfeetx1=sin(frameCount*0.1)*4
// let cfeety1=sin(frameCount*0.1)*4
// let cfeetx2=-sin(frameCount*0.1-PI)*4
// let cfeety2=sin(frameCount*0.1-PI)*4
...
function drawResilience() {
  ...
  for (let i = 0; i < 8; i++) {
    ...
    ballsR[i][0].pos.add(createVector(0,(noise(frameCount*0.02)-0.5)*10+mSin(frameCount*0.08)*6))
  }
